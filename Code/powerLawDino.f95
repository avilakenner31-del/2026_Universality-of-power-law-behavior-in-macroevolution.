program powerLawDino
implicit none

integer, parameter:: stps=100000, N=524
real, parameter:: devQ=sqrt(0.002), devM=sqrt(10000.), devN=sqrt(100.), sigma1=0.683, sigma2=0.954, sigma3=0.997
...
open(100, file='ListaGrado1.txt', status='old', action='read')
open(101, file='posteriorDino.txt')
